Feature: pretty output
  ...
  Rule: it should handle basic scenarios
    ...
    # https://github.com/cucumber/pretty-formatter/issues/23
    # Scenario: described feature
    #   Given a file named "cypress/e2e/a.feature" with:
    #     """
    #     Feature: a feature nam    #
    #       fooba    #
    #       Scenario: a scenario name
    #         Given a step
    #     """
    ...
    # https://github.com/cucumber/pretty-formatter/issues/24
    # @skip
    ...
    Background:
      Given a file named "cypress/e2e/a.feature" with:
        ...
        Feature: a feature
          ...
          @expose(origin="https://example.org/")
          Scenario: a scenario
            Given a step

          @env(origin="https://example.com/")
          @expose(origin="https://example.com/")
    ...
    Scenario: base case
      ...
      """
        Feature: a feature
          ...
          @env(origin="https://example.org/") @expose(origin="https://example.org/")
          Scenario: a scenario # cypress/e2e/a.feature:4
            ✔ Given a step     # not available:0

          @env(origin="https://example.com/") @expose(origin="https://example.com/")
